...
eternal_sunshine = media.Movie("Eternal Sunshine of the Spotless Mind",
                               "A man finds out his girlfriend erased him from his memory, when he retaliates he starts to regret it and tries to save the memory of her from being erased.",
...
holy_grail = media.Movie("Monty Python and the Quest for the Holy Grail",
                        "A King goes in search of knights to complete the quest to find the Holy Grail",
...
#call open_movies_page function from fresh_tomatoes file send the array 'movies'
